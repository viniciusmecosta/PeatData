...
@router.get("/sensor_data/last/{n}", response_model=List[SensorDataResponse], tags=["APP"])
...
@router.get("/sensor_data/days/{days}", response_model=List[SensorDataResponse], tags=["APP"])
...
@router.get("/sensor_data/date/{date}", response_model=List[SensorDataResponse], tags=["APP"])
